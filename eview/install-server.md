...
```bash
curl -fsSL https://files.hlscloud.de/eview/install.sh | bash
```

Für eine automatisierte Installation ohne Rückfragen:

```bash
curl -fsSL https://files.hlscloud.de/eview/install.sh | EASYVIEWING_LICENSE=EV1-IhrLizenzschluessel bash
```
